...
insert into restaurante (nome, taxa_frete, cozinha_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, endereco_cidade_id) values ("Thai gourmet", 10, 1, "38400-999", "Rua João Pinheiro", 1000, "Centro", 1);
